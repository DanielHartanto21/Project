...
public class SocketServer implements Runnable {
	...
	if (msg.content.equals(".bye")){
            ...
            if(msg.type.equals("login")){
                ...
                Announce("atas", msg.sender, msg.content);
            }
            else if(msg.type.equals("bawah")){
                Announce("bawah", msg.sender, msg.content);
            }
            else if(msg.type.equals("kanan")){
                Announce("kanan", msg.sender, msg.content);
            }
            else if(msg.type.equals("kiri")){
                Announce("kiri", msg.sender, msg.content);
            }
            else if(msg.type.equals("serang")){
                Announce("serang", msg.sender, msg.content);
            }
            else if(msg.type.equals("heal")){
                Announce("heal", msg.sender, msg.content);
            }
            else if(msg.type.equals("reset")){
                Announce("reset", msg.sender, msg.content);
            }
            else if(msg.type.equals("disable")){
                Announce("disable", msg.sender, msg.content);
            }
            else if(msg.type.equals("repair")){
                Announce("repair", msg.sender, msg.content);
            }
